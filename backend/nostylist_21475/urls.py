"""nostylist_21475 URL Configuration
...
admin.site.site_header = "NoStylist"
admin.site.site_title = "NoStylist Admin Portal"
admin.site.index_title = "NoStylist Admin"

# swagger
api_info = openapi.Info(
    title="NoStylist API",
    default_version="v1",
    description="API documentation for NoStylist App",
)
